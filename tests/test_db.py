...
class TestConnection:
    ...
    def test_get_db_url_from_env(self, monkeypatch):
        from omnipath_utils.db._connection import get_db_url
        monkeypatch.setenv('OMNIPATH_UTILS_DB_URL', 'postgresql://test:test@host/db')
...
class TestQuery:
    ...
    def test_translate_ids_returns_dict(self):
        ...
        result = translate_ids(mock_session, ['TP53', 'EGFR'], 'genesymbol', 'uniprot', 9606)
    ...
    def test_translate_ids_empty(self):
        ...
        result = translate_ids(mock_session, ['FAKE'], 'genesymbol', 'uniprot', 9606)
        assert result == {}
